...
def follow_line_simple(speed_black_left=SPEED_LINE_BLACK_L, speed_black_right=SPEED_LINE_BLACK_R, speed_white_left=SPEED_LINE_WHITE_L, speed_white_right=SPEED_LINE_WHITE_R, speed_other=SPEED_LINE_OTHER):
