...
def follow_line_simple_to_room():
    ...
    if floor_color == ColorValues.BLACK or floor_color == ColorValues.NONE:
        ev3_hardware.tank_drive.on(
            left_speed=SpeedConstants.LINE_BLACK_L,
            right_speed=SpeedConstants.LINE_BLACK_R,
        )
    elif floor_color == ColorValues.WHITE:
        ev3_hardware.tank_drive.on(
            left_speed=SpeedConstants.LINE_WHITE_L,
            right_speed=SpeedConstants.LINE_WHITE_R,
        )
    else:
        ev3_hardware.tank_drive.on(
            left_speed=SpeedConstants.LINE_OTHER, right_speed=SpeedConstants.LINE_OTHER
        )
